...
\
  ...
  # Create instance: smartconnect_core, and set properties
  ...
  # Create instance: xlslice_core_led, and set properties
  ...
  connect_bd_intf_net -intf_net core_0_M_AXI [get_bd_intf_pins core_0/M_AXI] [get_bd_intf_pins smartconnect_core/S00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_core_M00_AXI [get_bd_intf_pins smartconnect_core/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  ...
  connect_bd_net -net HD_GPIO_2_1  [get_bd_ports HD_GPIO_2] \
  ...
  connect_bd_net -net core_0_LED  [get_bd_pins core_0/LED] \
  [get_bd_pins xlslice_core_led/Din]
  connect_bd_net -net core_0_PERIPH_BYTEEN  [get_bd_pins core_0/PERIPH_BYTEEN] \
  [get_bd_pins display_1/BYTEEN] \
  [get_bd_pins draw_0/BYTEEN]
  connect_bd_net -net core_0_PERIPH_RDADDR  [get_bd_pins core_0/PERIPH_RDADDR] \
  [get_bd_pins display_1/RDADDR] \
  [get_bd_pins draw_0/RDADDR]
  connect_bd_net -net core_0_PERIPH_RDEN  [get_bd_pins core_0/PERIPH_RDEN] \
  [get_bd_pins display_1/RDEN] \
  [get_bd_pins draw_0/RDEN]
  connect_bd_net -net core_0_PERIPH_WDATA  [get_bd_pins core_0/PERIPH_WDATA] \
  [get_bd_pins display_1/WDATA] \
  [get_bd_pins draw_0/WDATA]
  connect_bd_net -net core_0_PERIPH_WRADDR  [get_bd_pins core_0/PERIPH_WRADDR] \
  [get_bd_pins display_1/WRADDR] \
  [get_bd_pins draw_0/WRADDR]
  connect_bd_net -net core_0_PERIPH_WREN  [get_bd_pins core_0/PERIPH_WREN] \
  [get_bd_pins display_1/WREN] \
  [get_bd_pins draw_0/WREN]
  connect_bd_net -net core_0_RDATA  [get_bd_pins core_0/RDATA] \
  [get_bd_pins regbus_0/RDATA_OPT0]
  connect_bd_net -net core_0_UART_TX  [get_bd_pins core_0/UART_TX] \
  [get_bd_ports HD_GPIO_1]
  ...
  connect_bd_net -net xlslice_core_led_Dout  [get_bd_pins xlslice_core_led/Dout] \
  [get_bd_ports LED]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces core_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces core_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
